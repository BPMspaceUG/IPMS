<!--  footer starts here -->
                ...
                <div class="row well" id="bpm-footer">
                  ...
                  <small><div class="col-md-9">
                    <ul class="list-inline">
                      ...
                      <li><a href="https://github.com/abodelot/jquery.json-viewer" target="_blank">jQuery json-viewer</a></li>
              ...
              <!-- uncomment line below for sample-example of a table. Its a sample format for the frontend -->
